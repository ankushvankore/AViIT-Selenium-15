...
public class D19HandlingDropdownList {
	...
	public static void main(String[] args) {
		...
		countries.selectByVisibleText("United Arab Emirates");
		//countries.selectByContainsVisibleText("Emirates");
		//countries.selectByValue("220");
		countries.selectByIndex(217);
		System.out.println("Selected Country: " + countries.getFirstSelectedOption().getText());
	}
